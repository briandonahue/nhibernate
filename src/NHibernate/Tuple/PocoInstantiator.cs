...
namespace NHibernate.Tuple
{
	...
	public class PocoInstantiator : IInstantiator, IDeserializationCallback
	{
		...
		private readonly bool useLazyProperty;
		...
		public PocoInstantiator(PersistentClass persistentClass, IInstantiationOptimizer optimizer, IProxyFactory proxyFactory, bool useLazyProperty)
		{
			...
			this.optimizer = optimizer;
			this.useLazyProperty = useLazyProperty;
		...
		public object Instantiate()
		{
			...
			if (useLazyProperty)
			{
				return proxyFactory.GetLazyPropertyInterceptionProxy();
			}
			if (optimizer != null)
			{
